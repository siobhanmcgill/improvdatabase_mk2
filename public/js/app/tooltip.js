...
(function ($) {
    ...
    Tooltip.prototype = {
        ...
        setString: function (str) {
            ...
            this.$el.data('tooltipstring', this.string);
        ...
        show: function () {
            ...
            if (this.$el.hasClass("left") || this.options.direction === "left" ||
                (this.$el.parent().outerWidth() < this.$el.parent().outerHeight() && (objLeft > $(window).width() * 0.6 || objLeft + objWidth < $(window).width() * 0.35)) ||
    ...
    $.fn.tooltip = function(option) {
        return this.each(function() {
            ...
            if (!data) {
                $(this).data('tooltip', (data = new Tooltip(this, $.extend(true, {}, $.fn.tooltip.defaults, options))));
            }
